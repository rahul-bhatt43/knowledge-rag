    ...
    return (
        <DashboardLayout>
            <div className="p-8 max-w-6xl mx-auto space-y-10 animate-in">
                ...
                {/* Filter Bar */}
                <div className="glass p-4 rounded-2xl flex items-center gap-4 bg-foreground/1 border-border">
                    <div className="relative flex-1">
                        <Search className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-muted-foreground" />
                        <input
                            type="text"
                            placeholder="Search by name or email..."
                            className="w-full h-11 bg-foreground/5 border border-border rounded-xl pl-10 pr-4 text-sm outline-none focus:border-primary/50 transition-all"
                        />
                    </div>
                    <div className="h-11 px-4 bg-foreground/5 border border-border rounded-xl flex items-center gap-2 text-sm text-muted-foreground font-medium">
                        Role: <span className="text-foreground">All</span>
                    </div>
                </div>

                {/* Users Table */}
                <div className="glass overflow-hidden rounded-3xl border-border bg-foreground/1">
